    ...
    render() {
        ...
        return (
            ...
            <Grid container spacing={24}>
                ...
                <Grid container spacing={8} item xs={12} sm={6} direction="column" >
                    <Grid item >
                        ...
                        <Typography variant="h5" color="secondary" gutterBottom>
                            ...
                            <Button className={classes.button} fullWidth variant="contained" color="secondary">
                                Buy now
                            </Button>
                        </Paper> 
                    </Grid> 
                    <Grid item> 
                        ...
                        <Typography variant="body1" gutterBottom>
                            Rere Wardrobe : Husna Outer CSR from Promo CSR . the latest muslim Cardigan collection with comfortable material to wear
                        </Typography>
                        <Typography variant="h5" gutterBottom>
                            Materials
                        </Typography>
